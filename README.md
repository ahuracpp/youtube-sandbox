# 📥 دانلود از یودیویوب با GitHub Actions

این مخزن با استفاد از **GitHub Actions** بهت اجازه می‌ده که فقط با **ارسال لینک یوتیوب توی پیام کامیت**، ویدیو به‌صورت خود تمومش کن کارر دانلود بشه و توی مخزن ذخیره بشه.
