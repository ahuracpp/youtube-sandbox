# 📥 دانلود هر چی از یوتیوب با GitHub Actions

این مخزن با استفاد از **GitHub Actions** بهت اجازه می‌ده که فقط با **ارسال لینک یوتیوب توی پیام کامیت**، ویدیو به‌صورت خودکارر دانلود بشه و توی مخزن ذخیره بشه.
